...
`table1` termasuk/tidak termasuk "Tidy data" karena iya, data casesnya sejenis termasuk tidy

```{r}
table2
```

`table2` termasuk/tidak termasuk "Tidy data" karena termasuk

```{r}
table3
```

`table3` termasuk/tidak termasuk "Tidy data" karena tidak karena rate hasilnya dibawah nol
...
`table4a` termasuk/tidak termasuk "Tidy data" karena ya krn data time series

```{r}
table4b
```

`table4b` termasuk/tidak termasuk "Tidy data" karena ya knr rime series

```{r}
table5
```

`table5` termasuk/tidak termasuk "Tidy data" karena tidak
